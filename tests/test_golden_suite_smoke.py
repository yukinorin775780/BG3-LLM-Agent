...
def test_golden_suite_contains_expected_minimum_cases():
    ...
    assert {
        ...
        "necromancer_lab_act2_astarion_reveals_gas_trap",
        "necromancer_lab_act2_disarm_trap_success",
        "necromancer_lab_act2_disarm_trap_failure_triggers_poison",
        "necromancer_lab_act2_astarion_ordered_to_disarm",
        "necromancer_lab_act2_corridor_door_lockpick_success_skips_study",
        "necromancer_lab_act2_corridor_door_lockpick_failure_hints_secret_study",
        "necromancer_lab_act3_side_with_astarion",
        "necromancer_lab_act3_rebuke_astarion",
        "necromancer_lab_act3_secret_study_entry",
        "necromancer_lab_act3_study_companion_observations",
        "necromancer_lab_act3_diary_success_information_advantage",
        "necromancer_lab_act3_diary_failure_fragment_only",
        "necromancer_lab_act3_chemical_notes_and_key_sketch",
        "necromancer_lab_act4_loot_key_and_escape",
        "necromancer_lab_full_path_act2_to_act4_truth_negotiation",
        "necromancer_lab_key_aware_guidance",
        "necromancer_lab_diary_changes_negotiation",
        "necromancer_lab_astarion_trap_intervention",
        "necromancer_lab_astarion_remembers_rebuke",
